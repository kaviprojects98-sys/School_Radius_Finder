...
const customSchoolList = [
    ...
    { id: 25, lat: 6.948605514897242, lng: 80.00693183248353, name: "Ananda Kanishta Vidyalaya Yabaraluwa" }
];
...
//
//   STUDENT_LAT,STUDENT_LNG|SCHOOL_ID|CUSTOMER_NUMBER|GENDER
//
// Example:
//   6.994635,80.017463|3|CN-10234|boy
//
...
function handleScannedData(rawText) {
    ...
    if (parts.length < 4) {
        showCustomPopup("⚠️ Barcode not recognized. Expected 4 fields separated by '|'.");
        return;
    }

    const [latLngPart, schoolIdPart, customerNumberPart, genderPart] = parts;
